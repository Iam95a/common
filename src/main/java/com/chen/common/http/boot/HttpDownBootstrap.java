package com.chen.common.http.boot;

import com.chen.common.http.constant.HttpDownStatus;
import com.chen.common.http.dispatch.HttpDownCallback;
import com.chen.common.http.entity.*;
import com.chen.common.http.exception.*;
import com.chen.common.http.handle.DownTimeoutHandler;
import com.chen.common.http.proxy.ProxyConfig;
import com.chen.common.http.proxy.ProxyHandleFactory;
import com.chen.common.http.util.FileUtil;
import com.chen.common.http.util.HttpDownUtil;
import com.chen.common.http.util.OsUtil;
import com.chen.common.http.util.ProtoUtil;
...
public class HttpDownBootstrap implements Serializable {
  ...
  private void connect(ConnectInfo connectInfo) {
    ProtoUtil.RequestProto requestProto = request.requestProto();
